...
describe CollectionRulesController do
  ...
  describe "GET 'index'" do
    ...
    it "should do a where if collection_rules is defined" do
      params = {collection_rules: {collection_title: "TAPUHI"}, environment: "development"}
  ...
  describe "GET 'show'" do
    it "should get the collection rule" do
      ...
      get :show, id: collection_rule.id, environment: "development"
  ...
  describe "GET 'edit'" do
    it "finds the collection_rule" do
      CollectionRules.should_receive(:find) { collection_rule }
      get :edit, id: collection_rule.id, environment: "development"
      assigns(:collection_rule).should eq collection_rule
    end
  end
  ...
  describe "POST 'create'" do
    it "should make a new collection rule and assign it" do
      CollectionRules.should_receive(:new) { collection_rule }
      post :create, collection_rule: { collection_title: "TAPUHI", status_codes: "203,205" }, environment: "development"
    ...
    it "should redirect_to the index page" do
      ...
      post :create, collection_rule: { collection_title: "TAPUHI", status_codes: "203,205" }, environment: "development"
      response.should redirect_to environment_collection_rules_path(environment: "development")
    end
  ...
  describe "PUT 'update'" do
    it "should find the collection_rule" do
      CollectionRules.should_receive(:find) { collection_rule }
      put :update, id: collection_rule.id, collection_rule: { collection_title: "TAPUHI", status_codes: "203,205" }, environment: "development"
      assigns(:collection_rule) { collection_rule }
    end
    ...
    it "updates all the attributes" do
      ...
      put :update, id: collection_rule.id, collection_rules: { collection_title: "TAPUHI", status_codes: "203,205" }, environment: "development"
    end
    ...
    context "collection_rule not valid" do
      it "should render the edit template" do
        ...
        post :update, id: collection_rule.id, collection_rules: { collection_title: "TAPUHI", status_codes: "203,205" }, environment: "development"
  ...
  describe "DELETE 'destroy'" do
    it "finds the collection rule and destroys it" do
      CollectionRules.should_receive(:find) { collection_rule }
      delete :destroy, id: collection_rule.id, environment: "development"
      response.should redirect_to environment_collection_rules_path(environment: "development")
    end
  end
