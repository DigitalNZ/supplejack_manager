...
$.extend(true, $.fn.dataTable.defaults, {
  ...
  oLanguage: {
    sLengthMenu:
      'Show <form class="custom dataTables"><select><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select></form> entries',
  },
  bLengthChange: false,
  iDisplayLength: 20,
});
    ...
    fnInit: function (oSettings, nPaging, fnDraw) {
      ...
      $(nPaging).append(
        '<ul class="data-tables pagination" role="navigation" aria-label="Pagination">' +
          '<li class="pagination-previous"><a href="#">&laquo; ' +
          oLang.sPrevious +
          "</a></li>" +
